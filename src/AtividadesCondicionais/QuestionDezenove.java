...
public class QuestionDezenove {
    public static void main(String[] args) {
        Scanner dadosEntrada = new Scanner(System.in);
        int numero;
        System.out.println("Por favor, digit um número menor que 1000: ");
        ...
        System.out.println("O número de centenas é de " + centena);
        System.out.println("O número de dezenas é de " + dezena);
        System.out.println("O número de unidades é de " + unidade);
    }
}
/*
